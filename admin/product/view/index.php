        ...
        if ($fac) {
            if (mysqli_num_rows($fac) <= 0) {
                ...
                foreach ($row as $rows) {
                    ...
                    echo '<a href="../delete?id=' . $id . '" class="del" target="_BLANK">Delete</a>';
                    echo '</div>';
                }
            }
        } else {
